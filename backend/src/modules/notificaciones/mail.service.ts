...
export class MailService {
  ...
  constructor(private configService: ConfigService) {
    // 1. Usamos ?? false para asegurar que si es undefined, sea false (boolean)
    this.mailEnabled = this.configService.get<boolean>('mail.enabled') ?? false;

    this.sender = {
      // 2. Usamos ?? para dar un valor por defecto si la configuración falla (string)
  ...
  private initializeClient() {
    try {
      // Forzamos que sea string, si no existe ponemos un string vacío
  ...
  async sendEmail(options: EmailOptions): Promise<boolean> {
    if (!this.mailEnabled || !this.client) {
      ...
      return true; // Devuelve true para simular éxito
    }
  ...
  private extractTextFromHtml(html: string): string {
    // Extraer texto simple del HTML para la versión de texto plano
    return html
    ...
    const testHtml = `
      ...
      <body>
        <div class="container">
          ...
          <div class="content">
            <h2>¡Hola!</h2>
            <p>Este es un correo de prueba enviado desde el sistema de gestión de onboarding.</p>
            <p><strong>Fecha y hora:</strong> ${new Date().toLocaleString('es-ES')}</p>
            <p><strong>Sistema:</strong> Backend NestJS con Mailtrap</p>
            <p>Si recibes este correo, significa que la configuración de notificaciones por correo está funcionando correctamente.</p>
            <p style="margin-top: 30px; padding: 15px; background: #e8f4fd; border-radius: 5px;">
              <strong>📧 Información técnica:</strong><br>
              • Servicio: Mailtrap API<br>
              • Método: Nodemailer + Mailtrap Transport<br>
  ...
  generateOnboardingTemplate(data: {
    ...
    return `
      ...
      <head>
        ...
        <title>Sesión de Onboarding</title>
        <style>
          * {
            margin: 0;
            padding: 0;
      ...
      <body>
        <div class="email-container">
          <div class="header">
            <h1>🎯 Sesión de Onboarding Programada</h1>
            <p>Sistema de Gestión de Onboarding Técnico</p>
          </div>
          
          <div class="content">
            <div class="greeting">Hola ${data.colaboradorNombre},</div>
            
            <p>Te informamos que has sido agendado para una sesión de onboarding técnico. A continuación encontrarás todos los detalles:</p>
            ...
            <div style="text-align: center; margin: 25px 0;">
              ...
              <p style="font-size: 12px; color: #666; margin-top: 5px;">
                El enlace estará activo 15 minutos antes del inicio
              </p>
            </div>
            ` : ''}
            ...
            <div class="highlight">
              ...
              <ul style="margin: 10px 0 10px 20px;">
                <li>Laptop con batería cargada</li>
            ...
            <p style="margin-top: 25px;">Si tienes alguna duda o impedimento para asistir, por favor comunícate con el administrador del sistema.</p>
          ...
          <div class="footer">
            <p>Este es un mensaje automático generado por el Sistema de Gestión de Onboarding.</p>
            <p>Por favor, no respondas a este correo.</p>
            <p>© ${new Date().getFullYear()} Sistema de Gestión de Onboarding. Todos los derechos reservados.</p>
          </div>
        </div>
      </body>
      </html>
      ...
      <body>
        <div class="email-container">
          <div class="header">
            ...
            <p>Tu sesión de onboarding está por comenzar</p>
          ...
          <div class="content">
            <div class="urgent-message">
              <h3>${data.sesionTitulo}</h3>
              <p>Tu sesión está programada para:</p>
            ...
            <p style="text-align: center; color: #666; font-size: 14px;">
              Por favor, asegúrate de estar listo con tiempo suficiente.
            </p>
          </div>
        </div>
      </body>
